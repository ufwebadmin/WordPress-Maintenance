...
is($dev->{wordpress}->{wp_cache}->{enabled}, 0, 'matched dev wp_cache value');
is($dev->{wordpress}->{options}->{fake_cache_ttl}, 300, 'matched dev fake_cache_ttl option value');
...
is($test->{wordpress}->{wp_cache}->{enabled}, 1, 'matched test wp_cache value');
is($test->{wordpress}->{options}->{fake_cache_ttl}, 3600, 'matched test fake_cache_ttl option value');
...
is($prod->{wordpress}->{wp_cache}->{enabled}, 1, 'matched prod wp_cache value');
is($prod->{wordpress}->{options}->{fake_cache_ttl}, 3600, 'matched prod fake_cache_ttl option value');
